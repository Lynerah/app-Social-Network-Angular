...
export class UserColorPreferenceService {
  ...
  load() {
    this.getColorScheme();
    this.renderer.addClass(document.body, this.colorScheme + this.colorSchemeSufix);
  }

  update(scheme: string) {
    this.setColorScheme(scheme);
    // Remove the old color-scheme class
    this.renderer.removeClass(document.body, (this.colorScheme === 'dark' ? 'light' : 'dark') + this.colorSchemeSufix);
    // Add the new / current color-scheme class
    this.renderer.addClass(document.body, scheme + this.colorSchemeSufix);
  }
